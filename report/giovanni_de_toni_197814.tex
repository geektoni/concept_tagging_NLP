...
One possible solution would be to build a custom Entity Recognition model specifically trained on the NL2SparQL4NLU dataset such to categorize more efficiently the various tokens. Moreover, more complex models \citep{gobbi2018concept} could be explored (e.g., deep neural networks)  and better features could be devised from the training dataset.
